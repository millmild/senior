...
//   const [trendProjects, setTrendProjects] = useState([]);
...
//     try {
//       // refresh trends from backend
//       await fetch("http://127.0.0.1:8000/trends/sync", {
//         method: "POST",
//       });

//       // load recommended projects based on trends
//       const res = await fetch(
//         "http://127.0.0.1:8000/projects/trending?limit=6",
//       );
//       const data = await res.json();
//       setTrendProjects(data);

//       // optional direct trends list if you add endpoint later
//       const trendRes = await fetch("http://127.0.0.1:8000/trending_topics");
...
//       {/* HEADER */}
//       <div className="mb-6">
//         <h1 className="text-3xl font-bold">📊 Smart Project Dashboard</h1>
//         <p className="text-gray-500 mt-1">
//           Search projects, view insights, and discover ideas from world trends.
//         </p>
//       </div>
...
//             🌍 Trending Topics + Recommended Projects
//           </h2>
...
//             {trends.length > 0 && (
//               <div className="mb-5">
//                 <p className="font-medium mb-2">🔥 Current Tech Trends</p>
...
//                 💡 Projects Matching Current Trends
//               </p>

//               <div className="grid md:grid-cols-2 gap-4">
//                 {trendProjects.map((item) => (
//                   <div
//                     key={item.id}
//                     onClick={() => navigate(`/project/${item.id}`)}
//                     className="border rounded-xl p-4 bg-gray-50 cursor-pointer hover:bg-green-50"
//                   >
...
//             placeholder="Try AI, IoT, Security..."
...
//               key={item.id}
//               onClick={() => navigate(`/project/${item.id}`)}
//               className="border rounded-xl p-4 cursor-pointer hover:bg-blue-50"
//             >
...
//           <h2 className="text-xl font-semibold">👨‍🏫 Top Advisors</h2>
...
//             >
//               <p className="text-xl font-bold text-blue-600">#{i + 1}</p>
//               <p>{a.advisor}</p>
//               <p className="text-sm text-gray-500">{a.count} projects</p>
//             </div>
//           ))}
//         </div>
//       </div>
